    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                    ...
                    <div class="card-body">
                        <form action="{{ route('reports.index') }}" method="GET" class="row align-items-end">
                            <div class="col-md-4">
                                ...
                                <select name="period" class="form-control" style="background-color: #252531; color: white; border: 1px solid #444;">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary px-4" style="background-color: #5a67d8; border: none;">
                                    <i class="fas fa-filter mr-2"></i> Filter
                                </button>
                                <a href="{{ route('reports.print-pdf', ['period' => request('period', 'today')]) }}" class="btn btn-danger px-4 ml-2">
                ...
                <div class="card mt-4" style="background-color: #1a1a24; color: white; border-radius: 12px; border: 1px solid #333;">
                            ...
                            <table class="table table-striped mb-0" style="color: #ccc;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge {{ $item->status == 'returned' ? 'badge-success' : 'badge-warning' }}">
                                                {{ ucfirst($item->status) }}
                                            </span>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-striped mb-0" style="color: #ccc;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-white font-weight-bold">{{ $item->user->name }}</td>
                                        <td>{{ $item->book->title }}</td>
                                        <td class="text-warning font-weight-bold">Rp {{ number_format($item->total_denda, 0, ',', '.') }}</td>
                                        <td>
                                            @if($item->bukti_pembayaran)
                                                <span class="text-success"><i class="fas fa-check-circle"></i> Terlampir</span>
                                            @else
                                    ...
                                    @empty
                                    <tr><td colspan="6" class="text-center py-4">Tidak ada riwayat denda.</td></tr>
                                    @endforelse
                                </tbody>
                            </table>
                        </div>
